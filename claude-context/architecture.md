...
notiflex-api Pod (v0.1.1, Go) [api-pool]
   ...
   └─→ Kafka (notiflex-kafka-kafka-bootstrap.kafka:9092) — notifications 토픽
```
...
| Tempo | 분산 트레이싱 (OTLP gRPC) | monitoring ns / ops-pool |
...
| kafka | notiflex-kafka (KRaft 4.1.0, Strimzi 0.51.0) |
