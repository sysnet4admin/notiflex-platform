...
- **docs/architecture-decisions.md** — 결정 ADR 누적 (ADR-001~012, 사람+AI 공동 검토)
...
ArgoCD auto-sync via root-app → Apps: notiflex-smb, notiflex-enterprise
   ↓ Argo Rollouts
Canary 점진 배포 (30초 간격)
```
...
| 네임스페이스 | 주요 워크로드 |
|-----------|------------|
| notiflex | notiflex-api (Rollout/Canary), valkey-primary (StatefulSet) |
...
- `docs/architecture-decisions.md` — ADR-001~012 누적
- `CLAUDE.md` — AI 행동 규칙
