...
| ch4 | 4.2 메트릭 모니터링 | ✅ | 2026-04-04 | kube-prometheus-stack |
| ch4 | 4.3 로그 수집 | ✅ | 2026-04-04 | Loki + Fluent Bit |
| ch4 | 4.4 알림 | ✅ | 2026-04-04 | Grafana alerting |
...
| ch7 | 7.4 멀티테넌시 | ✅ | 2026-04-04 | enterprise 테넌트 |
...
| worker-pool | e2-standard-2 | 1 | Kafka (Strimzi), Valkey |
...
| 챕터 | 문제 | 해결 |
|------|------|------|
| ch7 | enterprise valkey secret 패스워드 불일치 | 실제 Valkey 패스워드로 수정 |
